...
layout = dict(title='Force Measurements',
              ...
              xaxis=dict(title='Time (s)', showgrid=True, titlefont=dict(size=20), tickfont=dict(size=20), zeroline=False, showticklabels=False),
              yaxis=dict(title='Force (N)', showgrid=True, titlefont=dict(size=20), tickfont=dict(size=20), zeroline=False),
              width=500,
              height=300,
...
layout = dict(title='Temperature Measurements',
              titlefont=dict(size=20),
              xaxis=dict(title='Time (s)', showgrid=True, titlefont=dict(size=20), tickfont=dict(size=20), zeroline=False, showticklabels=False),
              yaxis=dict(title='Temperature (C)', showgrid=True, titlefont=dict(size=20), tickfont=dict(size=20), zeroline=False),
              width=500,
              height=300,
...
layout = dict(title='Contact Microphone Measurements',
              titlefont=dict(size=20),
              xaxis=dict(title='Time (s)', showgrid=True, titlefont=dict(size=20), tickfont=dict(size=20), zeroline=False, showticklabels=False),
              yaxis=dict(title='Contact Mic Signal (V)', showgrid=True, titlefont=dict(size=20), tickfont=dict(size=20), zeroline=False),
              width=500,
              height=300,
              legend=dict(font=dict(size=18)),
              showlegend=False)
...
plotly.offline.plot({'data': data, 'layout': layout}, filename='plots/table4.html')
...
data = []
# data.append(go.Scatter(x=x, y=force, name='Force', line=dict(dash='lines', width=4, color=colors[2]), mode='lines+markers', marker=dict(size=10)))
data.append(go.Scatter(x=x, y=temp, name='Temperature', line=dict(dash='lines', width=4, color=colors[3]), mode='lines+markers', marker=dict(size=10)))
# data.append(go.Scatter(x=x, y=contact, name='Contact mic', line=dict(dash='lines', width=4, color=colors[4]), mode='lines+markers', marker=dict(size=10)))
# data.append(go.Scatter(x=x, y=forcetemp, name='Force, Temperature', line=dict(dash='lines', width=4, color=colors[0]), mode='lines+markers', marker=dict(size=10)))
data.append(go.Scatter(x=x, y=forcetempcontact, name='Force, Temperature, Contact mic', line=dict(dash='lines', width=4, color=colors[1]), mode='lines+markers', marker=dict(size=10)))
...
layout = dict(title='Accuracy with Varying Labeled Training Data',
              titlefont=dict(size=20),
              xaxis=dict(title='Percent of Training Data Labeled (%)', showgrid=True, titlefont=dict(size=18), tickfont=dict(size=18), range=[0, 102]),
              yaxis=dict(title='Accuracy (%)', showgrid=True, titlefont=dict(size=18), tickfont=dict(size=18), range=[50, 100]),
              width=800,
              height=400,
              legend=dict(font=dict(size=14), x=0.5, y=0.2),
              showlegend=True)
